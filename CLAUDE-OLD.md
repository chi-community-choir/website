...
## > PREVIOUS IMPLEMENTATION. This is not the current reference for claude.

This is the old implementation plan before a rewrite was required. Only make reference to this to understand how the old implementation worked.
