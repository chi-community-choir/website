  ...
  return (
    <div className="bg-choir-warm-white border-2 border-choir-warm-gray rounded-lg p-6 text-center transition-all hover:shadow-lg hover:scale-[1.02] hover:border-choir-peach">
      ...
      {linkHref && linkText && (
        <Link
          href={linkHref}
          className="inline-block bg-choir-coral text-white px-6 py-3 rounded-lg text-lg no-underline mt-2 transition-all hover:bg-choir-coral/90 focus:outline-none focus:ring-2 focus:ring-choir-coral focus:ring-offset-2 active:translate-y-[1px] shadow-md"
        >
          {linkText}
        </Link>
      )}
