                ...
                <div className="space-y-2">
                  {song.sheetMusic?.map((sheet, index) => (
                    <a
                      ...
                      className="flex items-center gap-2 text-choir-blue hover:text-choir-blue-dark hover:underline p-3 bg-gray-50 rounded border border-gray-200 hover:border-choir-blue transition-colors"
                    >
